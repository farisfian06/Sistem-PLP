...
const AddUpdateAkunKoordinator = ({open, onClose, onSubmit, akunToEdit, errorMessage, onProcess}: Props) => {
    ...
    return (
        <Modal show={open} onClose={onClose}>
            <ModalHeader>
                {akunToEdit ? "Edit Akun Dosen Koordinator" : "Tambah Akun Dosen Koordinator"}
            </ModalHeader>
            <ModalBody>
...
export default AddUpdateAkunKoordinator;
